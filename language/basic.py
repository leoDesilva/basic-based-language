from basics import Context, Interpreter, SymbolTable
...
class BuiltInFunction(BaseFunction):
  ...
  def execute_input_prompt(self, exec_ctx):
    ...
    return RTResult().success(String(text))
  execute_input_prompt.arg_names = ['value']
  ...
  def execute_input_int_prompt(self, exec_ctx):
    while True:
        text = input(exec_ctx.symbol_table.get('value'))
        try:
            number = int(text)
            ...
            print(f"'{text}' must be an integer. Try again!")
    return RTResult().success(Number(number))
  execute_input_int_prompt.arg_names = ['value']
  ...
  def execute_random(self, exec_ctx):
    mini = exec_ctx.symbol_table.get("min").value
    maxi = exec_ctx.symbol_table.get("max").value
    return RTResult().success(random.randint(mini, maxi))
...
BuiltInFunction.input_int_prompt= BuiltInFunction("input_int_prompt")
...
global_symbol_table.set("true", Number.pi)
global_symbol_table.set("print", BuiltInFunction.print)
global_symbol_table.set("print_ret", BuiltInFunction.print_ret)
global_symbol_table.set("input", BuiltInFunction.input)
global_symbol_table.set("input_prompt", BuiltInFunction.input_prompt)
global_symbol_table.set("input_int", BuiltInFunction.input_int)
global_symbol_table.set("input_int_prompt", BuiltInFunction.execute_input_int_prompt)
